...
public class Plot {
    ...
    private SimpleFloatProperty pricePerMSquare;
    ...
    public float getPricePerMSquare() {
        if((getPrice() != 0) && (getArea() != 0)){
    ...
    public Plot(String text, String cityText, String districtText, String streetText, Integer integer, Integer valueOf) {
    }
}
